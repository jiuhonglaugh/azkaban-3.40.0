...
public class PropertiesUtils {
    ...
    public void print() {
        LOGGER.info("以下输出为配置文件中所有的配置项用来排查配置问题=============================");
        for (String key : zkPro.stringPropertyNames()) {
            LOGGER.info("keyName: " + key + " : " + zkPro.getProperty(key));
        }
        LOGGER.info("以上输出为配置文件中所有的配置项用来排查配置问题=============================");
    }
